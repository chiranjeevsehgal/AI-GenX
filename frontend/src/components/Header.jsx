...
export default function Header({ currentPage, settings }) {
  ...
  return (
    <>
      {/* Mobile Header - Below mobile nav */}
      <div className="lg:hidden pt-20 p-6 pb-0">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 mb-6">
          <div className="flex flex-col gap-4">
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 capitalize flex items-center gap-2">
            ...
            {/* Mobile API Status - Only show on dashboard, NO AUTH HERE */}
      ...
      {/* Desktop Header - For desktop layout */}
      <div className="hidden lg:block mb-6">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Authentication - ONLY SHOW ON DESKTOP */}
            <div className="flex items-center gap-3">
              <SignedOut>
