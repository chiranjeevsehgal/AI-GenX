...
- If the provided resume, resume summary, or attached file is an irrelevant or unrelated PDF (for example, not actually a candidate's resume), you MUST NOT use it. In such cases, you must simply respond by saying: "The attached file appears to be unrelated or not a valid resume. Please upload a relevant candidate resume to proceed", and do not generate any content in your response.
